...
def obtener_seleccion_usuario():
    ...
    while True:
        try:
            seleccion = int(input("""----------------------------------------------------\n
Elije un número: (1) Piedra, (2) Papel o (3) Tijera:\n
----------------------------------------------------\n"""))
...
def jugar_ronda(options):
    ...
    if ganador == "empate":
        ...
        print(f"La computadora había elegido: {cpu_selected['nombre']}. El usuario gana esta ronda")
    else:
...
def jugar_juego():
    ...
    if user_wins == 2:
        print("El usuario ganó el juego al mejor de 3!")
        return "user"
    else:
